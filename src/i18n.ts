...
export const translations = {
  en: {
    ...
    methodology: {
      ...
      subtitle: 'Grounded in academic standards, formal engineering models, and production practices designed for high system resilience.',
      workflow: {
        badge: 'Engineering Lifecycle',
        title: 'End-to-End Systems Engineering Workflow',
        subtitle: 'From academic research and formal market discovery through rigorous verification and continuous telemetry feedback.',
        stages: [
          {
            step: '01',
    ...
    tech: {
      ...
      categories: [
        ...
        },
        {
          ...
          items: ['MongoDB', 'PostgreSQL', 'Relational DDL & DML Engineering', 'Formal Normalization (1NF–BCNF)', 'Codd Relational Algebra & Chen ERD']
        },
        {
          name: 'Architecture & DevSecOps',
          items: ['Microservices', 'RESTful APIs', 'CI/CD Pipelines', 'Model-Based Systems Engineering (MBSE)', 'OMG UML 2.5 (Structural & Behavioral)', 'Event-Driven Architecture']
        },
        {
          name: 'Methodologies & Rigor',
          items: ['GenAI / LLM Integration', 'Clean Code', '23 GoF Design Patterns', 'Domain-Driven Design (DDD)', 'Kruchten 4+1 View Architecture', 'Agile (Scrum / Kanban)']
        }
      ]
    },
    docs: {
  ...
  pt: {
    ...
    methodology: {
      ...
      subtitle: 'Embasada em padrões acadêmicos, modelos formais de engenharia e práticas de produção voltadas para alta confiabilidade.',
      workflow: {
        badge: 'Ciclo de Vida',
        title: 'Fluxo de Engenharia de Sistemas',
        subtitle: 'Da pesquisa acadêmica e descoberta de mercado até a verificação rigorosa e evolução por telemetria contínua.',
        stages: [
          {
            step: '01',
    ...
    tech: {
      ...
      categories: [
        ...
        },
        {
          ...
          items: ['MongoDB', 'PostgreSQL', 'Engenharia de Schemas DDL & DML', 'Normalização Formal (1NF–BCNF)', 'Álgebra de Codd & Chen ERD']
        },
        {
          name: 'Arquitetura & DevSecOps',
          items: ['Microsserviços', 'APIs RESTful', 'Pipelines CI/CD', 'Model-Based Systems Engineering (MBSE)', 'OMG UML 2.5 (Estrutural & Comportamental)', 'Arquitetura Orientada a Eventos']
        },
        {
          name: 'Metodologias & Rigor',
          items: ['Integração GenAI / LLMs', 'Clean Code', '23 Padrões GoF', 'Domain-Driven Design (DDD)', 'Kruchten 4+1 View Architecture', 'Metodologias Ágeis (Scrum / Kanban)']
        }
      ]
    },
    docs: {
  ...
  es: {
    ...
    methodology: {
      ...
      subtitle: 'Basada en estándares académicos, modelos formales de ingeniería y prácticas de producción diseñadas para alta confiabilidad.',
      workflow: {
        badge: 'Ciclo de Vida',
        title: 'Flujo de Ingeniería de Sistemas',
        subtitle: 'Desde la investigación académica y análisis de mercado hasta la verificación rigurosa y telemetría continua.',
        stages: [
          {
            step: '01',
    ...
    tech: {
      ...
      categories: [
        ...
        },
        {
          ...
          items: ['MongoDB', 'PostgreSQL', 'Ingeniería de Esquemas DDL & DML', 'Normalización Formal (1NF–BCNF)', 'Álgebra de Codd & Chen ERD']
        },
        {
          name: 'Arquitectura & DevSecOps',
          items: ['Microservicios', 'APIs RESTful', 'Pipelines CI/CD', 'Model-Based Systems Engineering (MBSE)', 'OMG UML 2.5 (Estructural y Comportamental)', 'Arquitectura Orientada a Eventos']
        },
        {
          name: 'Metodologías & Rigor',
          items: ['Integración GenAI / LLMs', 'Clean Code', '23 Patrones GoF', 'Domain-Driven Design (DDD)', 'Kruchten 4+1 View Architecture', 'Metodologías Ágiles (Scrum / Kanban)']
        }
      ]
    },
    docs: {
