...
export const DOCS_INDEX: Record<Lang, DocItem[]> = {
  en: [
    {
      id: 'solid',
      ...
      highlights: [
        'SRP Actor Mapping',
        'OCP Polymorphic Extension',
        'LSP Subtyping Formalism',
        'ISP Role Tailoring',
        'DIP Hexagonal Boundaries',
      ],
    },
    {
      id: 'gof',
    ...
    },
    {
      ...
      highlights: [
        ...
        'Distributed Sagas (Orchestrated)',
    ...
    },
    {
      ...
      readTime: '12 min',
      highlights: [
        'Codd Relational Model & Completeness',
        'Chen ERD & Normalization (1NF–BCNF)',
        'Declarative DDL vs. DML Operators',
        'B+ Tree vs. LSM-Tree Asymptotics',
        'ARIES Recovery Protocol',
        'Isolation Anomalies & SSI',
      ],
    },
    {
      id: 'observability',
      ...
      highlights: [
        ...
        'Tail-Based Sampling',
        'SLI/SLO Error Budgets (Service Level)',
        'Automated Canary',
    ...
    },
    {
      ...
      readTime: '7 min',
      highlights: [
        'Zero Fallback Debt (7 Golden Rules)',
        'Zero Orphan Surfaces',
        'Cognitive Complexity Ceiling <= 15',
        'Coverage Floor Ratchets',
      ],
    },
    {
      ...
      subtitle: 'Branching Topologies, Defense-in-Depth & Release Predictability',
      file: 'architecture/gitflow-and-branching-strategy.md',
      readTime: '9 min',
      highlights: [
        'Immutable Mainline Principle',
        'Ephemeral Branch Lifetime <= 48h',
        'Three Concentric Quality Rings',
        'Gitleaks Full-History Sanitization',
        'Conventional Commits & PR Gate',
      ],
    },
    {
      id: 'automated-testing',
      category: 'Architecture',
      title: 'Automated Testing Strategy & Verification Architecture',
      subtitle: 'Testing Pyramids, Contract Boundaries, Test Doubles & Coverage Ratchets',
      file: 'architecture/automated-testing-strategy.md',
      readTime: '10 min',
      highlights: [
        'Boehm Verification vs Validation',
        'Multi-Tier Testing Trophy (Unit/Integration/E2E)',
        'Gerard Meszaros Test Double Taxonomy',
        'Unidirectional Coverage Floor Ratchet',
        'Zero Flakiness Engineering Protocol',
      ],
    },
    {
      id: 'persistence-cas',
    ...
    },
    {
      ...
      highlights: [
        ...
        'OMG UML 2.5 & Kruchten 4+1 View',
        'Parnas Information Hiding & OCL',
        'Boehm Verification vs. Validation',
        'Avizienis Fault/Error/Failure Taxonomy',
      ],
    },
    {
      id: 'complexity',
      ...
      readTime: '11 min',
      highlights: [
        'Landau Big-O Formalism (Knuth 1976)',
        "Little's Law L = lambda * W",
        'Universal Scalability Law (Gunther USL)',
        'Memory Hierarchy & L1/L2/L3 Cache Locality',
      ],
    },
    {
      id: 'academic-dsr',
      ...
      readTime: '8 min',
      highlights: [
        'Hevner 7 Guidelines (2004)',
        'Peffers 6-Stage Process (2007)',
        'Iterative Artifact Evaluation',
    ...
    },
    {
      ...
      highlights: [
        ...
        'Wiener Cybernetics & Feedback',
        'Ashby Law of Requisite Variety',
        'Emergence & Subsystem Hierarchy',
      ],
    },
  ],
  pt: [
    {
      ...
      readTime: '8 min',
      highlights: [
        'Mapeamento de Atores SRP',
        'Extensão Polimórfica OCP',
        'Formalismo de Subtipagem LSP',
        'Especialização de Papéis ISP',
        'Fronteiras Hexagonais DIP',
      ],
    },
    {
      id: 'gof',
      ...
      highlights: [
        '23 Padrões GoF',
        'Invariantes Anti-Pattern',
        'Factory / Strategy / Decorator',
        'Zero Instanciação Ad-Hoc',
      ],
    },
    {
      id: 'clean-arch',
    ...
    },
    {
      ...
      highlights: [
        ...
        'Intercambialidade de Infra',
        'Testabilidade Isolada',
        'Zero Acoplamento a Frameworks',
      ],
    },
    {
      id: 'distributed-theory',
      ...
      highlights: [
        ...
        'Impossibilidade FLP (1985)',
        'Relógios Lógicos de Lamport',
        'Princípio Ponta-a-Ponta (1984)',
      ],
    },
    {
      id: 'resilience',
      ...
      highlights: [
        ...
        'Sagas Distribuídas (Orquestradas)',
        'Circuit Breakers & Exponential Backoff',
        'Ledgers de Idempotência',
      ],
    },
    {
      id: 'database-internals',
      ...
      readTime: '12 min',
      highlights: [
        'Modelo Relacional de Codd & Completude',
        'Chen ERD & Normalização (1NF–BCNF)',
        'Operadores Declarativos DDL vs. DML',
        'Assintótica B+ Tree vs. LSM-Tree',
        'Protocolo de Recuperação ARIES',
        'Anomalias de Isolamento & SSI',
      ],
    },
    {
      id: 'observability',
      ...
      highlights: [
        'OpenTelemetry OTLP',
        'W3C Trace Context',
        '4 Sinais Dourados & RED/USE',
        'Tail-Based Sampling',
        'Orçamentos de Erro SLI/SLO (Metas de Serviço)',
        'Canary Automatizado',
    ...
    },
    {
      ...
      readTime: '7 min',
      highlights: [
        'Zero Dívida de Fallbacks (7 Regras de Ouro)',
        'Zero Superfícies Órfãs',
        'Teto de Complexidade Cognitiva <= 15',
        'Catraca de Cobertura de Testes',
      ],
    },
    {
      id: 'gitflow-branching',
      category: 'Architecture',
      title: 'GitFlow & Estratégia Moderna de Ramificação',
      subtitle: 'Topologias de Branch, Defesa em Profundidade & Previsibilidade de Release',
      file: 'architecture/gitflow-and-branching-strategy.md',
      readTime: '9 min',
      highlights: [
        'Princípio da Mainline Imutável',
        'Ciclo de Vida Efêmero <= 48h',
        'Três Anéis Concêntricos de Qualidade',
        'Gitleaks no Histórico Completo',
        'Conventional Commits & Gates de PR',
      ],
    },
    {
      id: 'automated-testing',
      category: 'Architecture',
      title: 'Estratégia de Testes Automatizados & Arquitetura de Verificação',
      subtitle: 'Pirâmides de Testes, Limites de Contrato, Test Doubles & Ratchets de Cobertura',
      file: 'architecture/automated-testing-strategy.md',
      readTime: '10 min',
      highlights: [
        'Verificação vs Validação de Boehm',
        'Troféu de Testes Multicamadas (Unit/Integration/E2E)',
        'Taxonomia de Test Doubles de Meszaros',
        'Ratchet de Piso de Cobertura Unidirecional',
        'Protocolo de Zero Flakiness',
      ],
    },
    {
      id: 'persistence-cas',
      ...
      readTime: '8 min',
      highlights: [
        'Endereçamento por Conteúdo (SHA-256)',
        'Grafo Acíclico Dirigido Merkle',
        'Invariantes de Imutabilidade',
        'Garbage Collection & Compactação',
      ],
    },
    {
      id: 'systems-engineering',
      ...
      highlights: [
        ...
        'Model-Based Systems Engineering (MBSE)',
        'OMG UML 2.5 & Kruchten 4+1 View',
        'Information Hiding de Parnas & OCL',
        'Verificação vs. Validação de Boehm',
        'Taxonomia de Falha/Erro/Defeito de Avizienis',
      ],
    },
    {
      id: 'complexity',
      ...
      readTime: '11 min',
      highlights: [
        'Formalismo Big-O de Landau (Knuth 1976)',
        'Lei de Little L = lambda * W',
        'Lei Universal de Escalabilidade (Gunther USL)',
        'Hierarquia de Memória & Localidade L1/L2/L3',
      ],
    },
    {
      id: 'academic-dsr',
      ...
      readTime: '8 min',
      highlights: [
        '7 Diretrizes de Hevner (2004)',
        'Processo em 6 Estágios de Peffers (2007)',
        'Avaliação Iterativa de Artefatos',
        'Zero Afirmações Especulativas',
      ],
    },
    {
      id: 'systems-theory',
      ...
      readTime: '8 min',
      highlights: [
        'Teoria Geral dos Sistemas de Bertalanffy',
        'Cibernética & Feedback de Wiener',
        'Lei da Variedade Requisita de Ashby',
        'Emergência & Hierarquia de Subsistemas',
      ],
    },
  ],
  es: [
    {
      ...
      readTime: '8 min',
      highlights: [
        'Mapeo de Actores SRP',
        'Extensión Polimórfica OCP',
        'Formalismo de Subtipado LSP',
        'Especialización de Roles ISP',
        'Fronteras Hexagonales DIP',
      ],
    },
    {
      id: 'gof',
      ...
      highlights: [
        '23 Patrones GoF',
        'Invariantes Anti-Patrón',
        'Factory / Strategy / Decorator',
        'Cero Instanciación Ad-Hoc',
      ],
    },
    {
      id: 'clean-arch',
    ...
    },
    {
      ...
      readTime: '8 min',
      highlights: [
        'Puertos Inbound & Outbound',
        'Intercambiabilidad de Infra',
        'Testabilidad Aislada',
        'Cero Acoplamiento a Frameworks',
      ],
    },
    {
      id: 'distributed-theory',
      ...
      readTime: '11 min',
      highlights: [
        '8 Falacias de la Computación Distribuida',
        'Imposibilidad FLP (1985)',
        'Relojes Lógicos de Lamport',
        'Principio Fin-a-Fin (1984)',
      ],
    },
    {
      id: 'resilience',
      ...
      highlights: [
        ...
        'Sagas Distribuidas (Orquestadas)',
        'Circuit Breakers & Exponential Backoff',
    ...
    },
    {
      ...
      readTime: '12 min',
      highlights: [
        'Modelo Relacional de Codd & Completitud',
        'Chen ERD & Normalización (1NF–BCNF)',
        'Operadores Declarativos DDL vs. DML',
        'Asintótica B+ Tree vs. LSM-Tree',
        'Protocolo de Recuperación ARIES',
        'Anomalías de Aislamiento & SSI',
      ],
    },
    {
      id: 'observability',
      ...
      highlights: [
        'OpenTelemetry OTLP',
        'W3C Trace Context',
        '4 Señales Doradas & RED/USE',
        'Tail-Based Sampling',
        'Presupuestos de Error SLI/SLO (Metas de Servicio)',
        'Canary Automatizado',
    ...
    },
    {
      ...
      readTime: '7 min',
      highlights: [
        'Cero Deuda de Fallbacks (7 Reglas de Oro)',
        'Cero Superficies Huérfanas',
        'Techo de Complejidad Cognitiva <= 15',
        'Trinquete de Cobertura de Pruebas',
      ],
    },
    {
      id: 'gitflow-branching',
      category: 'Architecture',
      title: 'GitFlow & Estrategia Moderna de Ramificación',
      subtitle: 'Topologías de Rama, Defensa en Profundidad & Predecibilidad de Releases',
      file: 'architecture/gitflow-and-branching-strategy.md',
      readTime: '9 min',
      highlights: [
        'Principio de Tronco Inmutable',
        'Ciclo de Vida Efímero <= 48h',
        'Tres Anillos Concéntricos de Calidad',
        'Gitleaks en Historial Completo',
        'Conventional Commits & Gates de PR',
      ],
    },
    {
      id: 'automated-testing',
      category: 'Architecture',
      title: 'Estrategia de Pruebas Automatizadas & Arquitectura de Verificación',
      subtitle: 'Pirámides de Pruebas, Límites de Contrato, Test Doubles & Ratchets de Cobertura',
      file: 'architecture/automated-testing-strategy.md',
      readTime: '10 min',
      highlights: [
        'Verificación vs Validación de Boehm',
        'Trofeo de Pruebas Multicapa (Unit/Integration/E2E)',
        'Taxonomía de Test Doubles de Meszaros',
        'Ratchet de Umbral de Cobertura Unidireccional',
        'Protocolo de Cero Pruebas Inestables',
      ],
    },
    {
      id: 'persistence-cas',
      ...
      highlights: [
        ...
        'Grafo Acíclico Dirigido Merkle',
        'Invariantes de Inmutabilidad',
        'Recolección de Basura & Compactación',
      ],
    },
    {
      id: 'systems-engineering',
      ...
      highlights: [
        ...
        'Information Hiding de Parnas & OCL',
        'Verificación vs. Validación de Boehm',
        'Taxonomía de Fallo/Error/Avería de Avizienis',
      ],
    },
    {
      id: 'complexity',
      ...
      highlights: [
        ...
        'Ley Universal de Escalabilidad (Gunther USL)',
        'Jerarquía de Memoria & Localidad L1/L2/L3',
      ],
    },
    {
      id: 'academic-dsr',
      ...
      readTime: '8 min',
      highlights: [
        '7 Directrices de Hevner (2004)',
        'Proceso en 6 Etapas de Peffers (2007)',
        'Evaluación Iterativa de Artefactos',
        'Cero Afirmaciones Especulativas',
      ],
    },
    {
      id: 'systems-theory',
      ...
      highlights: [
        ...
        'Cibernética & Retroalimentación de Wiener',
        'Ley de Variedad Requerida de Ashby',
        'Emergencia & Jerarquía de Subsistemas',
      ],
    },
  ],
};
